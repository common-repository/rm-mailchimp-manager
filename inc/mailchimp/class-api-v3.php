...
/**
 * Class MCManager_API_v3
 */
class MCManager_API_v3 {

	/**
	 * @var MCManager_API_v3_Client
	 */
	protected $client;
	...
	public function __construct( $api_key ) {
		$this->client = new MCManager_API_v3_Client( $api_key );
	}

	/**
	 * Gets the API client to perform raw API calls.
	 *
	 * @return MCManager_API_v3_Client
	 */
	 ...
	 *
	 * @return boolean
	 * @throws MCManager_API_Exception
	 */
	 ...
	 *
	 * @link https://developer.mailchimp.com/documentation/mailchimp/reference/templates/#%20
	 * @param array $args
	 * @return object
	 * @throws MCManager_API_Exception
	 */
	...
	/**
	 * Update some or all of the settings for a specific template.
	 *
	 * @link https://developer.mailchimp.com/documentation/mailchimp/reference/templates/#%20
	 ...
	 * @throws MCManager_API_Exception
	 */
	public function update_template( $template_id, array $args ) {
		$resource = sprintf( '/templates/%s', $template_id );
		return $this->client->patch( $resource, $args );
	}

	/**
	 * Remove a template from the MailChimp account
	 *
	 * @link https://developer.mailchimp.com/documentation/mailchimp/reference/templates/#%20
	 * @param string $template_id
	 * @return bool
